...
if !([CALLER_OWNER, _unit, _pid, _side, "TON_fnc_getVehicles"] call TON_fnc_checkCaller) exitWith {};
//Error checks
...
if (_side == "Error") exitWith {
    [[]] remoteExec ["life_fnc_impoundMenu",_unit]; //_unit ist hier schon die owner-ID
};
