...
class CfgRemoteExec {
    class Functions {
        ...
        F(life_fnc_adminCompReceive,CLIENT)
        F(life_fnc_adminHealed,CLIENT)
        F(life_fnc_adminID,CLIENT)
        F(life_fnc_adminInfo,CLIENT)
        F(life_fnc_adminLicenseReceive,CLIENT)
        F(life_fnc_adminManageInfo,CLIENT)
        F(life_fnc_adminManageResult,CLIENT)
        F(life_fnc_adminQueryReply,CLIENT)
        F(life_fnc_adminRankReceive,CLIENT)
        ...
        F(TON_fnc_adminManageAction,SERVER)
        F(TON_fnc_adminManageQuery,SERVER)
        F(TON_fnc_skillsLoad,SERVER)
        F(TON_fnc_skillsSave,SERVER)
        F(TON_fnc_dutyInfo,SERVER)
        F(TON_fnc_dutySwitch,SERVER)
        ...
        F(TON_fnc_invDrop,SERVER)
        F(TON_fnc_invDropped,SERVER)
        F(TON_fnc_invHarvest,SERVER)
        F(TON_fnc_invTrunk,SERVER)
        F(TON_fnc_trunkMine,SERVER)
        F(TON_fnc_invConvert,SERVER)
        F(TON_fnc_adminMoneyQuery,SERVER)
        F(TON_fnc_econReport,SERVER)
        F(TON_fnc_custody,SERVER)
        F(TON_fnc_vehicleKeys,SERVER)
        F(TON_fnc_houseDoor,SERVER)
